...
router.post("/signup", (req, res, next) => {
    const { email, fullName, password, verifyToken, imageUrl } = req.body
        ...
        .then(foundUser => {
            ...
            return User.create({
                ...
                let mailDetails = {
                    ...
                    html: `Hello,<br /><br />Thank you for creating your account on our app! <a href="${process.env.ORIGIN}/dashboard/verify/${verifyToken}/${createdUser._id}">Click here to verify your account</a>.`,
                }
