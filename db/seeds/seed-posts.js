...
const authors = [
    "62399c8b05749e1a7d1b9e11",
    "62399c8b05749e1a7d1b9e12",
    "62399c8b05749e1a7d1b9e13",
    "62399c8b05749e1a7d1b9e14",
    "62399c8b05749e1a7d1b9e15",
    "62399c8b05749e1a7d1b9e16",
]
...
for (let i = 0; i < titles.length; i++) {
    ...
    fakePosts.push({
        title: titles[i],
        date: getRandomDate(2020, 2022),
        time: getRandomTime(8, 19),
        category: category,
        tags: [
            titles[i],
            category,
